    ...
    <div className="min-h-screen flex flex-col bg-[#f5f1e8]">
      ...
      <header className="bg-[#0000cc] text-white py-4 px-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="flex gap-8">
            ...
            <a href="/software" className="hover:text-gray-200 transition-colors">
              Our Software
            </a>
            <a href="/team" className="hover:text-gray-200 transition-colors">
              Our Team
            </a>
            <a href="/contact" className="hover:text-gray-200 transition-colors font-semibold">
              Contact
            </a>
          </nav>
        </div>
      ...
      <main className="flex-1 px-8 py-16">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl font-bold text-[#0000cc] text-center mb-4">Contact Us</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-md p-8">
              <h3 className="text-2xl font-bold text-[#0000cc] mb-6">Legal Notice</h3>

              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <span className="text-[#0000cc] font-bold mt-1">📝</span>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Thomas-Mann-Strasse 17, 68799 Reilingen</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <span className="text-[#0000cc] font-bold mt-1">☎️</span>
                  <div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <h3 className="text-2xl font-bold text-[#0000cc] mb-6">Get In Touch</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="https://discord.gg/kaK6BXpdfV" className="text-[#0000cc] hover:underline">
                      Join our Discord
                    </a>
                  </div>
                </div>
      ...
      <footer className="bg-[#0000cc] text-white py-8">
        <div className="max-w-7xl mx-auto flex justify-center gap-8">
          <a href="#twitter" className="hover:text-gray-300 transition-colors" aria-label="Twitter">
          ...
          <a href="#instagram" className="hover:text-gray-300 transition-colors" aria-label="Instagram">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" fill="#0000cc"></path>
              <circle cx="17.5" cy="6.5" r="1.5" fill="#0000cc"></circle>
            </svg>
          </a>
          <a href="#youtube" className="hover:text-gray-300 transition-colors" aria-label="YouTube">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02" fill="#0000cc"></polygon>
            </svg>
          </a>
        </div>
      </footer>
